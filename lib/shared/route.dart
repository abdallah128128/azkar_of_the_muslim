...
class AppRouter{
  ...
  static Route<dynamic>? getRoutes(RouteSettings settings) {
    switch(settings.name){
      ...
      case '/Morning':
        return MaterialPageRoute(builder: (context) =>   MorningAzkar(),);
      case '/Evening':
        return MaterialPageRoute(builder: (context) =>   EveningAzkar(),);
      case '/WakingUp':
        return MaterialPageRoute(builder: (context) =>   WakingUpAzkar(),);
      case '/Sleep':
        return MaterialPageRoute(builder: (context) =>   SleepAzkar(),);
      case '/Home':
        return MaterialPageRoute(builder: (context) =>   HomeAzkar(),);
      case '/Eating':
        return MaterialPageRoute(builder: (context) =>   EatingAzkar(),);
      case '/Prayer':
        return MaterialPageRoute(builder: (context) =>   PrayerAzkar(),);
      case '/Travel':
        return MaterialPageRoute(builder: (context) =>   TravelAzkar(),);
      case '/Mosque':
        return MaterialPageRoute(builder: (context) =>   MosqueAzkar(),);
      case '/Nature':
        return MaterialPageRoute(builder: (context) =>   NatureAzkar(),);
      case '/Problems':
        return MaterialPageRoute(builder: (context) =>   ProblemsAzkar(),);
      case '/Other':
        return MaterialPageRoute(builder: (context) =>   OtherAzkar(),);
      case '/Quran':
        return MaterialPageRoute(builder: (context) =>   Quran(),);
    }
  }
}