              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  MyGridItem(
                      ...
                      icon: Icons.bed, title: "النوم"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Home');
                      },
                      icon: Icons.home, title: "المنزل"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Eating');
                      },
                      icon: Icons.fastfood, title: "الطعام"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Prayer');
                      },
                      icon: Icons.mosque, title: "الصلاة"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Travel');
                      },
                      icon: Icons.drive_eta, title: "السفر"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Mosque');
                      },
                      icon: Icons.mosque, title: "الآذان والمسجد"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Nature');
                      },
                      icon: Icons.eco, title: "الطبيعة"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Problems');
                      },
                      icon: Icons.fireplace, title: "المصائب والهموم"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Other');
                      },
                      icon: Icons.add, title: "أذكار متفرقة"),
                  MyGridItem(
                      onClick: () {
                        Navigator.pushNamed(context, '/Quran');
                      },
                      icon: Icons.mosque, title: "أدعية قرآنية"),
                ],
              ),
            ),
